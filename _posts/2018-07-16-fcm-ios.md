...
# Firebase 5.4 Push Notification For IOS 11
...
크론이 됬던 어떤 서비스가 됬던 특정 시점에 알림보낼 내용과 아이디를 뽑아올수있으면 db에서 firebase token을 찾아서 포함시켜서 firebase  end point로 http리퀘스트만 보내주면 끝난다. 
