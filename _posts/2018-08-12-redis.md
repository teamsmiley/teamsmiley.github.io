...
| 기능 | key | 예제값|
|:---|:---:|:---|:---|
글 리스트 | REDIS_KEY + ":" + boardName + ":" + param |  documents:blogs:Category=/Search=/OrderBy=regdate desc/Fields=/WithNoPublish=True/CurrentPage=1/PageSize=9/|
글 페이징 | REDIS_KEY + ":" + boardName + ":" + param + ":pagination" |documents:blogs:Category=/Search=/OrderBy=regdate desc/Fields=/WithNoPublish=True/CurrentPage=1/PageSize=9/:pagination|
글        | REDIS_KEY + ":" + boardName + ":" + id + ":" + fields | "documents:blogs:d282dd96-ef39-49cd-c674-08d5cbe021c7:aaa=aaa"| 
글 삭제시 | REDIS_KEY + ":" + boardName + ":" + id | documents:blogs:d282dd96-ef39-49cd-c674-08d5cbe021c7| 
새 글 쓸때| REDIS_KEY + ":" + boardName   | "documents:blogs"| 
글 업데이트| REDIS_KEY + ":" + boardName + ":" + id | documents:blogs:d282dd96-ef39-49cd-c674-08d5cbe021c7|
글 패치    | REDIS_KEY + ":" + boardName + ":" + id | documents:blogs:d282dd96-ef39-49cd-c674-08d5cbe021c7|

캐싱을 키로 지울때 *로 다 지워질수 있게 설계가 되야한다.
